...
typedef void (*UniffiCallbackInterfaceExternalSignerMethod16)(uint64_t uniffi_handle, RustBuffer secret_key, RustBuffer receiver_public_key, UniffiForeignFutureCompleteRustBuffer uniffi_future_callback, uint64_t uniffi_callback_data, UniffiForeignFuture* uniffi_out_return);

// Making function static works arround:
// https://github.com/golang/go/issues/11263
static void call_UniffiCallbackInterfaceExternalSignerMethod16(
				UniffiCallbackInterfaceExternalSignerMethod16 cb, uint64_t uniffi_handle, RustBuffer secret_key, RustBuffer receiver_public_key, UniffiForeignFutureCompleteRustBuffer uniffi_future_callback, uint64_t uniffi_callback_data, UniffiForeignFuture* uniffi_out_return)
{
	return cb(uniffi_handle, secret_key, receiver_public_key, uniffi_future_callback, uniffi_callback_data, uniffi_out_return);
}
...
typedef void (*UniffiCallbackInterfaceExternalSignerMethod17)(uint64_t uniffi_handle, RustBuffer secret_key, UniffiForeignFutureCompleteRustBuffer uniffi_future_callback, uint64_t uniffi_callback_data, UniffiForeignFuture* uniffi_out_return);

// Making function static works arround:
// https://github.com/golang/go/issues/11263
static void call_UniffiCallbackInterfaceExternalSignerMethod17(
				UniffiCallbackInterfaceExternalSignerMethod17 cb, uint64_t uniffi_handle, RustBuffer secret_key, UniffiForeignFutureCompleteRustBuffer uniffi_future_callback, uint64_t uniffi_callback_data, UniffiForeignFuture* uniffi_out_return)
{
	return cb(uniffi_handle, secret_key, uniffi_future_callback, uniffi_callback_data, uniffi_out_return);
}
...
typedef struct UniffiVTableCallbackInterfaceExternalSigner {
    ...
    UniffiCallbackInterfaceExternalSignerMethod11 staticDepositSecretKeyEncrypted;
    ...
    UniffiCallbackInterfaceExternalSignerMethod16 encryptSecretKeyForReceiver;
    UniffiCallbackInterfaceExternalSignerMethod17 publicKeyFromSecretKeySource;
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_FN_METHOD_EXTERNALSIGNER_STATIC_DEPOSIT_SECRET_KEY_ENCRYPTED
#define UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_FN_METHOD_EXTERNALSIGNER_STATIC_DEPOSIT_SECRET_KEY_ENCRYPTED
uint64_t uniffi_breez_sdk_spark_fn_method_externalsigner_static_deposit_secret_key_encrypted(void* ptr, uint32_t index
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_FN_METHOD_EXTERNALSIGNER_ENCRYPT_SECRET_KEY_FOR_RECEIVER
#define UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_FN_METHOD_EXTERNALSIGNER_ENCRYPT_SECRET_KEY_FOR_RECEIVER
uint64_t uniffi_breez_sdk_spark_fn_method_externalsigner_encrypt_secret_key_for_receiver(void* ptr, RustBuffer secret_key, RustBuffer receiver_public_key
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_FN_METHOD_EXTERNALSIGNER_PUBLIC_KEY_FROM_SECRET_KEY_SOURCE
#define UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_FN_METHOD_EXTERNALSIGNER_PUBLIC_KEY_FROM_SECRET_KEY_SOURCE
uint64_t uniffi_breez_sdk_spark_fn_method_externalsigner_public_key_from_secret_key_source(void* ptr, RustBuffer secret_key
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_CHECKSUM_METHOD_EXTERNALSIGNER_STATIC_DEPOSIT_SECRET_KEY_ENCRYPTED
#define UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_CHECKSUM_METHOD_EXTERNALSIGNER_STATIC_DEPOSIT_SECRET_KEY_ENCRYPTED
uint16_t uniffi_breez_sdk_spark_checksum_method_externalsigner_static_deposit_secret_key_encrypted(void
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_CHECKSUM_METHOD_EXTERNALSIGNER_ENCRYPT_SECRET_KEY_FOR_RECEIVER
#define UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_CHECKSUM_METHOD_EXTERNALSIGNER_ENCRYPT_SECRET_KEY_FOR_RECEIVER
uint16_t uniffi_breez_sdk_spark_checksum_method_externalsigner_encrypt_secret_key_for_receiver(void
    
);
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_CHECKSUM_METHOD_EXTERNALSIGNER_PUBLIC_KEY_FROM_SECRET_KEY_SOURCE
#define UNIFFI_FFIDEF_UNIFFI_BREEZ_SDK_SPARK_CHECKSUM_METHOD_EXTERNALSIGNER_PUBLIC_KEY_FROM_SECRET_KEY_SOURCE
uint16_t uniffi_breez_sdk_spark_checksum_method_externalsigner_public_key_from_secret_key_source(void
...
uint32_t ffi_breez_sdk_spark_uniffi_contract_version(void
 ...
 void breez_sdk_spark_cgo_dispatchCallbackInterfaceExternalSignerMethod16(uint64_t uniffi_handle, RustBuffer secret_key, RustBuffer receiver_public_key, UniffiForeignFutureCompleteRustBuffer uniffi_future_callback, uint64_t uniffi_callback_data, UniffiForeignFuture* uniffi_out_return);
 void breez_sdk_spark_cgo_dispatchCallbackInterfaceExternalSignerMethod17(uint64_t uniffi_handle, RustBuffer secret_key, UniffiForeignFutureCompleteRustBuffer uniffi_future_callback, uint64_t uniffi_callback_data, UniffiForeignFuture* uniffi_out_return);
